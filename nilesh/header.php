  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header row">
      		...
      		<div class="col-md-7">
      			<button class="close " data-dismiss="modal">&times;</button>
            <form action="save.php" method="post">a
            <table cellpadding="10" cellspacing="0">
      			<tr>
      				<td><h2>Create Account</h2></td>
      			</tr>
      				<tr>
      					<td><input style="border-style: none;" type="text" name="first name" placeholder="Enter Frist Name"><hr/></td>
      				</tr>
      				...
      				<tr>
      					<td><input style="border-style: none;" type="text" name="enter email" placeholder="Enter Email"><hr/></td>
      				</tr>
      				<<tr>
      					<td><input style="border-style: none;" type="passward" name="enter your passward" placeholder=" Enter Your Passward"><hr/></td>
      				</tr>
      				<tr>
	...
	<button class="navbar-toggler " type="button" data-toggle="collapse" data-target="#idtarget">
        ...
        <li class="nav-item">
          <a  class="nav-link text-light ml-4 navbar_link <?php if(strstr($url,'index.php')){echo"navbar_link_active";}?>" href="index.php">Home</a>
        </li>
				<li class="nav-item">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header row">
      		...
      		<div class="col-md-7">
				...
				<li class="nav-item">
					<a  class="nav-link text-light ml-4 navbar_link <?php if(strstr($url,'about.php')){echo"navbar_link_active";}?>" href="about.php">about</a>
				</li>
				<li class="nav-item dropdown">
					<a class="nav-link text-light ml-4 dropdown-toggle navbar_link " href="#" data-toggle="dropdown" >more</a>
